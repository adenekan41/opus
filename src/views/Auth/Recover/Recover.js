	...
	render() {
			...
			<div className="RecoverBody Recover__opus-insight">
				...
				<h1 className="text-center">Recover password</h1>
					<p className="text-center">Type in the email address associated with your account to get a recovery link.</p> 
					<div className="row">
						...
						<div className="col-md-5">
							...
							<form action="">
								...
								<button class="btn btn-dark btn-block">Recover password</button><br />
